...
ALTER TABLE EmpId_Salary
ADD FOREIGN KEY (empId) REFERENCES EmpId_All_Details(Emp_Id)
...
SELECT EmpId_All_Details.name,EmpId_Salary.Basic_Pay
From EmpId_All_Details
Inner join EmpId_Salary on EmpId_All_Details.Emp_Id=EmpId_Salary.empId

SELECT EmpId_All_Details.Emp_Id,EmpId_DepartmentId.departmentId,EmpId_All_Details.name
FROM EmpId_All_Details
Inner join EmpId_DepartmentId
on EmpId_All_Details.Emp_Id=EmpId_DepartmentId.empId
